...
#  foreach::foreach(boot.count=1:nb) %dopar% {
#  for(boot.count in 1:nb){
    ...
    if(intv==3){
      ...
      return(list(RD1,RD2,RD3,RR1,RR2,RR3,OR1,OR2,OR3,NA,NA,NA))
    }else if(intv==4){
      ...
      return(list(RD1,RD2,RD3,RR1,RR2,RR3,OR1,OR2,OR3,RD4,RR4,OR4))
    }
#  }
#   return(var.boot)
 }
