PSE_four=function(GT,x0,x1,confounders,V.matrix){
  ...
  omega_values=data.table(p0000=p0000[1],p1000=p1000[1],p1100=p1100[1],p1110=p1110[1],p1111=p1111[1])
  ...
  return(list(omega=omega_values,RD=data.table(rbind(RD1,RD2,RD3,RD4)),
              RR=data.table(rbind(RR1,RR2,RR3,RR4)),OR=data.table(rbind(OR1,OR2,OR3,OR4))))
}
